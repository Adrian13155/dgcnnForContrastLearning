import sys
sys.path.append("/data/cjj/projects/PointCloudLearning/dgcnn/pytorch")
import torch.nn as nn
import torch
import torch.nn.functional as F
from utils.GDANet_util import local_operator, GDM, SGCAM
...
if __name__ == "__main__":
    ...
    pts = torch.randn(4, 3, 1024).cuda()
    model = GDANET().cuda()
    logits, point_feat = model(pts)
    print(logits.shape)
